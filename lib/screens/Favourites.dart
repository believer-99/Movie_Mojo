                            ...
                            children: [
                                  ...
                                  onTap: () => Navigator.of(context).push(
                                    MaterialPageRoute(
                                      builder: (ctx) => MovieDetails(
                                        lan: widget.favMovies[index].original_language,
                                        overview: widget.favMovies[index].overview,
                                        poster_path: 'https://image.tmdb.org/t/p/w500' + widget.favMovies[index].poster_path,
                                        release: widget.favMovies[index].release.toString(),
                                        title: widget.favMovies[index].title,
                                        vote_average: widget.favMovies[index].vote_average.toString(),
                                        backdrop_path: 'https://image.tmdb.org/t/p/w500' + widget.favMovies[index].backdrop_path,
                                      ),
                                    ),
                                  ),
                                  child: Image(
                                    filterQuality: FilterQuality.high,
                                    image: NetworkImage('https://image.tmdb.org/t/p/w500' + widget.favMovies[index].backdrop_path),
                                    height: 200,
                                    fit: BoxFit.fill,
                                  ),
                                ),
                              ...
                              Positioned(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      'Name : ' + widget.favMovies[index].title,
                                    ...
                                    Text(
                                      'Rating : ' + (widget.favMovies[index].vote_average.toString()),
                                      style: typeStyle.copyWith(
                                        fontWeight: FontWeight.w500,
                                      ),
                                    ),
